...
export function HexlyLink() {
	return (
		<HeaderTooltip label="Bogo on hexly.ai">
			<Button
				variant="ghost"
				size="icon"
			...
			>
				<a
					href="https://hexly.ai/projects/bogo"
					target="_blank"
					rel="noopener noreferrer"
					aria-label="Bogo on hexly.ai (opens in a new tab)"
				>
					<svg
						className="size-[18px]"
						width="18"
					...
					<span className="sr-only">Bogo on hexly.ai (opens in a new tab)</span>
				</a>
			</Button>
		</HeaderTooltip>
	);
